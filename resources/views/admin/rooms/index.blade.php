...
<div class="table-responsive col-lg-12">
    <table class="table table-sm table-bordered table-hover border-dark text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="{{ asset('storage/' . $room->image) }}" alt="Gambar Kamar {{ $room->room_type }}" width="150" class="img-fluid"></td>
                <td>
                    <a href="{{ route('rooms.edit', $room->id) }}" class="badge bg-dark" onclick="return confirm('Apakah Anda Yakin?')">
                        <span>Edit</span></a>
    ...
    <div class="text-end">
        <a href="{{ route('rooms.create') }}" class="btn btn-success mb-3">Create new Kamar</a>
    </div>
