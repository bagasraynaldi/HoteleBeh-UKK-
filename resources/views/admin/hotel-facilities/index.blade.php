...
<div class="table-responsive col-lg-12">
    <table class="table table-sm table-bordered table-hover border-dark text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('hotel-facilities.edit', $hotel_facility->id) }}" class="badge bg-dark" onclick="return confirm('Apakah Anda Yakin?')">
                        <span>Edit</span></a>
    ...
    <div class="text-end">
        <a href="{{ route('hotel-facilities.create') }}" class="btn btn-success mb-3">Create new Fasilitas Hotel</a>
    </div>
