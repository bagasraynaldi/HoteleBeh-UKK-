    ...
    <div class="table-responsive col-lg-12">
        <table class="table table-sm table-bordered table-hover border-dark text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{ asset('storage/' . $room_facility->image) }}" alt="Gambar {{ $room_facility->facility_name }}" width="150" class="img-fluid"></td>
                    <td>
                        <a href="{{ route('room-facilities.edit', $room_facility->id) }}" class="badge bg-dark" onclick="return confirm('Apakah Anda Yakin?')">
                            <span>Edit</span></a>
        ...
        <div class="text-end">
            <a href="{{ route('room-facilities.create') }}" class="btn btn-success mb-3">Create new Fasilitas Kamar</a>
        </div>
