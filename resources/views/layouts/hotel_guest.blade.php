                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a href="/facilities" class="nav-link {{ Request::is('facilities') ? 'active' : '' }}">Fasilitas Hotel</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item text-nowrap ms-3">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="btn-success" type="submit" onclick="return('anda yakin ingin keluar?')">Back </button>
                                </form>
                            </li>
                        </ul>
                    </div>
